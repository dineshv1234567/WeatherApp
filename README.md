...
It also has the feature to add it to the favourites so that person can vist his/her favourite city once in a lifetime. Atmoost 10 cities can be included. Once visited, person can remove the city from the favourites list.# ClearSky
